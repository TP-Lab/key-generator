        ...
        <v-tab icon="icon-eos" title="EOS">
          ...
          <div>
            ...
            <p>
              ...
              <br />
              <input readonly type="text" id="eos-public-key" :value="eosPublicKey" />
              <button
            ...
            <p>
              ...
              <br />
              <input readonly type="text" id="eos-private-key" :value="eosPrivateKey" />
              <button
        ...
        <v-tab icon="icon-eth" title="ETH">
          ...
          <div>
            ...
            <p>
              {{$t('i18nView.publicKey')}}:
              <br />
              <input readonly type="text" id="eth-public-key" :value="ethPublicKey" />
              <button
            ...
            <p>
              {{$t('i18nView.privateKey')}}:
              <br />
              <input readonly type="text" id="eth-private-key" :value="ethPrivateKey" />
              <button
        ...
        <v-tab icon="icon-iost" title="IOST">
          ...
          <div>
            ...
            <p>
              {{$t('i18nView.publicKey')}}:
              <br />
              <input readonly type="text" id="iost-public-key" :value="iostPublicKey" />
              <button
            ...
            <p>
              {{$t('i18nView.privateKey')}}:
              <br />
              <input readonly type="text" id="iost-private-key" :value="iostPrivateKey" />
              <button
        ...
        <v-tab icon="icon-tron" title="TRON">
          ...
          <div>
            ...
            <p>
              {{$t('i18nView.publicKey')}}:
              <br />
              <input readonly type="text" id="tron-public-key" :value="tronPublicKey" />
              <button
            ...
            <p>
              {{$t('i18nView.privateKey')}}:
              <br />
              <input readonly type="text" id="tron-private-key" :value="tronPrivateKey" />
              <button
        ...
        <v-tab icon="icon-btc" title="BTC">
          ...
          <div>
            ...
            <p>
              ...
              <br />
              <input readonly type="text" id="btc-public-key" :value="btcPublicKey" />
              <button
            ...
            <p>
              ...
              <br />
              <input readonly type="text" id="btcP2SH-public-key" :value="btcP2SHPublicKey" />
              <button
            ...
            <p>
              ...
              <br />
              <input readonly type="text" id="btcSegwit-public-key" :value="btcSegwitPublicKey" />
              <button
            ...
            <p>
              {{$t('i18nView.privateKey')}}:
              <br />
              <input readonly type="text" id="btc-private-key" :value="btcPrivateKey" />
              <button
        ...
        <v-tab icon="icon-cosmos" title="Cosmos">
          ...
          <div>
            ...
            <p>
              {{$t('i18nView.publicKey')}}:
              <br />
              <input readonly type="text" id="cosmos-public-key" :value="cosmosPublicKey" />
              <button
            ...
            <p>
              {{$t('i18nView.privateKey')}}:
              <br />
              <input readonly type="text" id="cosmos-private-key" :value="cosmosPrivateKey" />
              <button
        ...
        <v-tab icon="icon-binance" title="Binance">
          ...
          <div>
            ...
            <p>
              {{$t('i18nView.publicKey')}}:
              <br />
              <input readonly type="text" id="binance-public-key" :value="binancePublicKey" />
              <button
            ...
            <p>
              {{$t('i18nView.privateKey')}}:
              <br />
              <input readonly type="text" id="binance-private-key" :value="binancePrivateKey" />
              <button
        ...
        <v-tab icon="icon-nervos" title="Nervos">
          ...
          <div>
            ...
            <p>
              {{$t('i18nView.publicKey')}}:
              <br />
              <input readonly type="text" id="nervos-public-key" :value="nervosPublicKey" />
              <button
            ...
            <p>
              {{$t('i18nView.privateKey')}}:
              <br />
              <input readonly type="text" id="nervos-private-key" :value="nervosPrivateKey" />
              <button
